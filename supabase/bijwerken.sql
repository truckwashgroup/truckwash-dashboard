-- ===========================================================================
--  Bijwerken: migratie 0017 tot en met 0023
--
--  Plak dit in de SQL-editor van Supabase en druk op Run.
--
--  Opnieuw draaien mag. Twijfel je of je een eerdere migratie hebt gedraaid,
--  neem dan supabase/setup.sql -- dat is het geheel, en dat mag ook opnieuw.
--
--  Wat erin zit:
