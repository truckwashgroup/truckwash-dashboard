...
import { ArrowRight, BarChart3, Building2, ClipboardList, Code2, HardHat, LogOut, ShieldCheck, Wrench } from 'lucide-react'
...
const ORDER: Role[] = ['employee', 'supervisor', 'technician', 'customer', 'management', 'developer']
